...
const ProductPage: React.FC = () => {
  ...
  // ✅ pesan sukses setelah create / update
  ...
  const loadProducts = async () => {
    ...
    try {
      ...
      // ✅ sort: produk terbaru (updatedAt / createdAt) di paling atas
  ...
  // ✅ dipanggil setelah create / update dari FormProduct
  const handleFormSaved = async () => {
    await loadProducts();
              ...
              <table className={styles.table}>
                ...
                <tbody>
                  {paginatedProducts.map((product) => {
                    ...
                    // ✅ ambil thumbnail dari imageUrls[0] dulu, baru fallback ke imageUrl
                    const thumbUrl =
                      (product.imageUrls &&
                        product.imageUrls[0]) ||
                      product.imageUrl ||
